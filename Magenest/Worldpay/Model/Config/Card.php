 ...
 */
namespace Magenest\Payments\Model\Config;
...
class Card extends \Magenest\Worldpay\Model\Config
{
     ...
     * @var string
     */
    protected $methodCode = 'worldpay_payments_card';
    ...
    /**
     * @var \Magento\Sales\Model\System\Config\Source\Country
     */
    ...
    {
        try {
            $countriesCardTypes = $this->_serializer->unserialize($this->getConfigData(self::KEY_COUNTRY_CREDIT_CARD));
        } catch (\Exception $e) {
