...
/**
 * Class WorldpayCard
 * @package Magenest\Worldpay\Model\Methods
 */
class WorldpayCard extends WorldpayPayments
{

    protected $_formBlockType = 'Magenest\Worldpay\Block\Form\Card';
     ...
     * @return $this|WorldpayPayments|\Magento\Payment\Model\Method\AbstractMethod
    ...
    public function assignData(\Magento\Framework\DataObject $data)
    {
        ...
        if (isset($_tmpData['additional_data'])) {
            ...
            if (isset($_serializedAdditionalData['paymentToken'])) {
                $_paymentToken = $_serializedAdditionalData['paymentToken'];
            }
            $_saveCard = isset($_serializedAdditionalData['saveCard']) ? $_serializedAdditionalData['saveCard'] : false;
        }
        parent::assignData($data);
        $infoInstance = $this->getInfoInstance();

        if (isset($_paymentToken) && isset($_saveCard)) {
        ...
        if (($this->customerSession->isLoggedIn() || $this->backendAuthSession->isLoggedIn()) && isset($_paymentToken)) {
            ...
            if (empty($token_exists['token'])) {
                $model = $this->_objectManager->create('Magenest\Worldpay\Model\SavedCard');
        ...
        try {
            ...
            if ($response['paymentStatus'] === 'SUCCESS') {
                ...
                foreach ($quoteItems as $quoteItem) {
                    ...
                    $itemAmount = $this->subscriptionHelper->getQuoteAmountForSubscriptionItem($quote, $quoteItem);
    ...
    /**
     * @param InfoInterface $payment
     * @return bool|\Magento\Payment\Model\Method\AbstractMethod|void
     * @throws LocalizedException
     */
