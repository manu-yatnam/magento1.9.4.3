...
function wpShowMenuPopup(objMenu, event, popupId)
{
    ...
    jQuery('.itemMenu.level1 .outerclass1:first-child').addClass('menu_disp1');
     jQuery('.itemMenu.level1 .outerclass1:not(:first-child)').hover(function(){
        jQuery('.itemMenu.level1 .outerclass1:first-child').removeClass('menu_disp1');
